...
class TestMapRowWithColumnMappings:
    ...
    def test_map_row_simple_mapping(self):
        ...
        source_row = {"customer_id": "123", "customer_name": "Alice"}
        ...
        mappings = [
            ...
            ColumnMapping(
                task_id=1, source_field="customer_name", dest_column="NAME", is_active=True
            ),
        ]

        result = map_row_with_column_mappings(source_row, mappings)

        assert result == {"CUST_ID": "123", "NAME": "Alice"}

    def test_map_row_with_transforms(self):
        """Test mapping with transforms"""
        source_row = {"full_name": "  alice  "}
